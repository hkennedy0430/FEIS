...
if __name__ == "__main__":      
        ...
        n_feats_list = [5,10,15,25,30,100]
        parameters = {"epsilon": [0,0.01,0.1,0.5], "C": [1,2,4], "max_iter": [10000]}
        if args.test:
        ...
        grid_search = RegressorGridSearch(LinearSVR, n_feats_list, mode=mode, discrete_waveform=discrete_waveform)
